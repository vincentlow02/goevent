      ...
      <div className="flex flex-col gap-[13px]">
        ...
        <div className="flex items-end justify-between gap-[12px]">
          <div>
            ...
            <p className="text-[11px] font-bold leading-[17px] text-[#999999]">Gates open 6:00pm</p>
          </div>
          <button
...
function EmptyTicketState() {
  return (
    <div className="flex w-full flex-1 items-center justify-center rounded-[24px] border border-[#ececec] bg-[#fbfbfb] px-[24px] py-[42px] text-center shadow-[0_4px_29.3px_rgba(0,0,0,0.04)]">
      <div>
        <p className="text-[18px] font-bold leading-[24px] text-[#0f172a]">No tickets yet</p>
        <p className="mt-[8px] text-[13px] leading-[20px] text-[#6b7280]">
          Your booked events will appear here after you complete checkout.
        </p>
      </div>
    </div>
  );
        ...
        <div className="flex flex-1 flex-col gap-[30px]">
          ...
          <div className="flex flex-col gap-[19px]">
            ...
            <div className="flex items-center gap-[8px] overflow-x-auto pb-[2px]">
              <TicketSegment active>{`Upcoming(${hasPurchasedTicket ? 1 : 0})`}</TicketSegment>
...
function DetailInfoCard({
  ...
  return (
    <div className="flex-1 rounded-[16px] border border-[#f3f4f6] bg-white px-[16px] py-[16px] shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
      <p className="text-[10px] font-bold uppercase leading-[15px] text-[#9ca3af]">{title}</p>
        ...
        <div className="relative -mt-[20px] rounded-t-[20px] bg-white px-[26px] pb-[48px] pt-[32px]">
          <div className="flex flex-col gap-[32px]">
              ...
              <div className="flex items-start justify-between gap-[16px]">
                <div>
                  ...
                  >
                    ...
                    <p className="text-[13px] leading-[20px] text-black">DRESS GRAPE, SHIBUYA</p>
                  </motion.div>
                </div>
            ...
            <motion.div className="flex gap-[16px]" {...bodyTransition}>
              <DetailInfoCard title="Date & Time" value="Tonight, Aug 24" subtext="8:00 PM - 11:30 PM" />
              <DetailInfoCard title="Entry Fee" value={formatYen(3500)} subtext="Includes 1 Drink" />
            </motion.div>

            <motion.div {...bodyTransition}>
              <h2 className="text-[18px] font-bold leading-[28px] text-[#0f172a]">About the Event</h2>
              <p className="text-[14px] leading-[22.75px] text-[#4b5563]">
                Experience an enchanting evening of contemporary jazz set against the breathtaking skyline of
                Shibuya. DRESS GRAPE&apos;s rooftop transforms into an intimate musical sanctuary as the sun
                sets. Featuring a rotating lineup of Tokyo&apos;s finest jazz musicians.
              </p>
            </motion.div>

            <motion.div {...bodyTransition}>
              <h2 className="mb-[16px] text-[18px] font-bold leading-[28px] text-[#0f172a]">Tonight&apos;s Lineup</h2>
              <div className="flex flex-col gap-[16px]">
                <ArtistRow image={assets.detailArtist1} genre="Contemporary Jazz / Saxophone" name="Kenji Tanaka Trio" time="8:30 PM" />
                <ArtistRow bordered={false} image={assets.detailArtist2} genre="Vocal Jazz / Soul" name="Sarah Ohara" time="10:00 PM" />
              </div>
            </motion.div>

            <motion.div {...bodyTransition}>
              <h2 className="mb-[19px] text-[18px] font-bold leading-[28px] text-[#0f172a]">Location</h2>
              ...
              <div className="mt-[19px] flex items-start justify-between gap-[16px]">
                <div>
                  ...
                  <p className="text-[12px] leading-[16px] text-[#6b7280]">Shibuya, Sakuragaokacho, 1-1-1F</p>
                </div>
...
export function BookingPage({
  ...
  const overlayOpacity = Math.max(0, 0.24 - dragY / 420);
  const isDragging = dragStartYRef.current !== null;
    ...
    <div className="absolute inset-0 z-30 overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-end">
        <motion.div
          ...
          transition={isDragging ? { duration: 0 } : { duration: 0.34, ease: [0.22, 1, 0.36, 1] }}
          ...
          <div className="relative z-10 flex min-h-[calc(100dvh-34px)] max-h-[calc(100dvh-34px)] flex-col rounded-t-[28px] border border-[rgba(255,255,255,0.7)] bg-white px-[20px] pb-[28px] pt-[16px] shadow-[0_-24px_60px_rgba(15,23,42,0.18)]">
            ...
            >
              ...
              <AnimatePresence initial={false} mode="wait">
                ...
                >
                  {isSuccessStep ? "Thank you!" : isPaymentStep ? "Payment" : "Book Tickets"}
                </motion.p>
              </AnimatePresence>
            </motion.div>
                      ...
                      >
                        ...
                        <div className="mt-[15px] flex w-full flex-col items-center">
                          <div className="text-center">
                            <p className="text-[24px] font-bold tracking-[1px] text-[#272222]">Thank you!</p>
                            <p className="mt-px text-[14px] font-semibold text-[#7d7d7d]">
                              Your registration is complete!
                            </p>
                          </div>

                          <div className="mt-[36px] w-full rounded-[12px] border border-[rgba(20,184,166,0.1)] bg-[rgba(20,184,166,0.05)] px-[17px] py-[14px]">
                            <p className="text-center text-[13px] leading-[22.75px] text-[#475569]">
                              A confirmation email with your registration details has been sent to
                            </p>
                            <p className="text-center text-[13px] leading-[22.75px] text-[#14b8a6]">
                              a12307042@zokei.ac.jp
                            </p>
                          </div>
            ...
            >
              <div className="flex items-center justify-between gap-[12px]">
                <div>
                  ...
                  <p className="mt-[3px] text-[22px] font-bold leading-[1.1] text-[#352c2c]">{formatYen(totalAmount)}</p>
                </div>
                <motion.button
                  className={`h-[41px] rounded-[20px] bg-[#04bcb4] px-[22px] text-[13px] font-bold tracking-[1px] text-white disabled:opacity-60 ${
                ...
                >
                  {isPaymentStep ? "Pay Now" : "Proceed to payment"}
                </motion.button>
              </div>
            </motion.div>
          </div>
      ...
      <div className="relative h-[calc(100dvh-53px)] overflow-hidden">
        ...
        <div className="relative z-10 mt-[11px] flex h-[calc(100%-11px)] flex-col rounded-t-[15px] bg-white px-[26px] pb-[40px] pt-[40px]">
          <div className="flex items-center justify-between">
            <p className="pl-[104px] text-[18px] font-bold leading-[28px] text-black">Thank you!</p>
          ...
          <div className="flex flex-1 flex-col items-center justify-start pt-[88px]">
            ...
            <div className="mt-[15px] flex w-full flex-col items-center">
              <div className="text-center">
                <p className="text-[24px] font-bold tracking-[1px] text-[#272222]">Thank you!</p>
                <p className="mt-px text-[14px] font-semibold text-[#7d7d7d]">Your registration is complete!</p>
              </div>
              ...
              <div className="mt-[36px] w-full rounded-[12px] border border-[rgba(20,184,166,0.1)] bg-[rgba(20,184,166,0.05)] px-[17px] py-[14px]">
                ...
                <p className="text-center text-[13px] leading-[22.75px] text-[#14b8a6]">{email}</p>
              </div>
