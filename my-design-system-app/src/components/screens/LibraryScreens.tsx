...
const assets = {
  ...
  profileBell: "/profile/bell.svg",
  profileChevron: "/profile/chevron.svg",
  profileCrown: "/profile/crown.svg",
  profileHelp: "/profile/help.svg",
  profileNotifications: "/profile/notifications.svg",
  profileOrganize: "/profile/organize.svg",
  profilePayments: "/profile/payments.svg",
  profilePersonal: "/profile/personal.svg",
  profilePrivacy: "/profile/privacy.svg",
  profileRewards: "/profile/rewards.svg",
  savedArtWorkshop: "/saved/art-workshop.jpg",
  savedConcert: "/saved/concert.jpg",
  savedLocalMeetups: "/saved/local-meetups.jpg",
  savedMusicFestival: "/saved/music-festival.jpg",
  savedParty: "/saved/party.jpg",
  savedRecentIcon: "/saved/recent-icon.svg",
} as const;
      ...
      <div className="flex min-h-[calc(100dvh-51px)] flex-col">
        <div className="flex flex-col gap-[20px]">
          <div className="flex flex-col items-end gap-[18px]">
            ...
            <h1 className="w-full text-[32px] font-bold leading-[20px] text-black">Saved</h1>
          </div>

          <div className="grid grid-cols-2 gap-x-[16px] gap-y-[32px]">
            <SavedCard title="Recently viewed">
            ...
            <SavedCard itemCount="12 items" title="Music Festivals">
            ...
            <SavedCard itemCount="5 items" title="Art Workshops">
            ...
            <SavedCard itemCount="8 items" title="Local Meetups">
              <div className="overflow-hidden rounded-[16px] bg-[#f3f4f6]">
        ...
        <div className="flex flex-col gap-[33px]">
          <div className="flex flex-col gap-[26px]">
            <div className="flex items-center justify-between">
              <h1 className="text-[30px] font-bold tracking-[-0.75px] text-[#0f172a]">Profile</h1>
            ...
            <div className="flex items-center gap-[29px]">
              ...
              <div>
                ...
                <div className="mt-[2px] flex items-center gap-[6px]">
                  ...
                  <span className="text-[14px] font-medium leading-[20px] text-[#475569]">Silver Member</span>
                </div>
          ...
          <div className="flex flex-col gap-[16px]">
            <div className="rounded-[12px] border border-[#e2e8f0] bg-white p-[20px] shadow-[0_4px_29.3px_rgba(0,0,0,0.07),0_1px_2px_rgba(0,0,0,0.05)]">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-[1px] text-[#04bcb4]">Member Rewards</p>
                  <p className="mt-[4px] text-[24px] font-bold leading-[32px] text-[#0f172a]">
                    2,450 <span className="text-[14px] font-normal text-[#64748b]">pts</span>
                  </p>
                </div>
              ...
              <p className="mt-[12px] text-[12px] leading-[16px] text-[#64748b]">
                550 points until <span className="font-bold text-[#0f172a]">Gold Status</span>
              </p>
            ...
            <div className="flex items-center justify-between rounded-[12px] border border-[#e2e8f0] bg-white p-[21px] shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
              <div>
                <p className="text-[16px] font-bold leading-[24px] text-[#0f172a]">Organize an event</p>
                <p className="mt-[2px] text-[14px] leading-[20px] text-[#64748b]">
                  List your event and reach thousands of people.
                </p>
              </div>
            ...
            <div className="rounded-[19px] bg-white px-[24px] py-[16px]">
              <h2 className="pb-[16px] text-[18px] font-bold leading-[28px] text-[#0f172a]">Settings</h2>
              <ProfileSettingRow icon={assets.profilePersonal} iconClassName="h-[16px] w-[16px]" label="Personal Information" />
              <ProfileSettingRow icon={assets.profilePayments} iconClassName="h-[16px] w-[22px]" label="Payments and Payouts" />
              <ProfileSettingRow icon={assets.profileNotifications} iconClassName="h-[20px] w-[16px]" label="Notifications" />
              <ProfileSettingRow icon={assets.profilePrivacy} iconClassName="h-[20px] w-[16px]" label="Privacy and Sharing" />
              <ProfileSettingRow chevronClassName="h-[12px] w-[7.4px]" icon={assets.profileHelp} iconClassName="h-[20px] w-[20px]" label="Get Help" />
            </div>
          </div>
        </div>
