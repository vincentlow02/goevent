  ...
  return (
    <div className="flex h-[28px] items-center rounded-[999px] border border-[rgba(255,255,255,0.3)] bg-[rgba(255,255,255,0.74)] px-[11px] shadow-[0_1px_2px_rgba(0,0,0,0.05)] backdrop-blur-[4px]">
      <img
        ...
        src={icon}
      />
      <span className="text-[11px] font-medium leading-[20px] text-[#334155]">{label}</span>
    </div>
  );
}
      ...
      <div className="flex items-center gap-[12px]">
          ...
          <div className="min-w-0 flex-1">
            ...
            >
              ...
              <p className="truncate text-[10px] leading-[16px] text-[#4e4e4e]">DRESS GRAPE , SHIBUYA</p>
      ...
      <div className="relative flex min-w-[156px] items-center gap-[12px] rounded-full border-[2.5px] border-[#00C2B8] bg-white py-[4px] pl-[8px] pr-[20px] shadow-[0_8px_20px_rgba(15,23,42,0.1)] whitespace-nowrap">
        ...
        <div className="flex flex-col justify-center pb-[0.5px]">
          <div className="flex items-center gap-[4px]">
            <span className="text-[11px] font-bold leading-[1.15] tracking-[0.1px] text-black">Summer</span>
            <img alt="" className="h-[11px] w-[11px] object-contain" src={discoverAssets.tumbler} />
          </div>
          <span className="text-[11px] font-bold leading-[1.15] tracking-[0.1px] text-black">Rooftop Jazz</span>
        </div>
      </div>
...
function DiscoverSearchPanel({
  ...
  const overlayOpacity = Math.max(0, (isOpen ? 1 : 0) - dragY / 220);
  ...
  const handlePointerMove = (event: React.PointerEvent<HTMLDivElement>) => {
    ...
    const deltaX = Math.abs(event.clientX - (dragStartXRef.current ?? event.clientX));
  ...
  return (
    <div className="absolute inset-0 z-20 overflow-hidden pointer-events-none">
      <div
        className={`absolute inset-0 bg-[rgba(15,23,42,0.12)] transition-opacity duration-300 ease-out ${
      ...
      <div
        className={`pointer-events-auto absolute inset-x-0 top-[38px] bottom-0 rounded-tl-[28px] rounded-tr-[40px] bg-[#f7f7f7] px-[28px] pb-[36px] pt-[28px] transition-all duration-300 ease-out ${
          isOpen ? "translate-y-0 opacity-100" : "translate-y-[18px] opacity-0"
        }`}
        ...
        >
          ...
          >
            <SearchResultCard
              ...
              rank="No.1"
              subtitle="Venue: Hibiya park"
              title="Tokyo Music Festival special"
            />
          </div>
          <div
            className={`transition-all duration-300 ease-out ${
          ...
          >
            <SearchResultCard
              ...
              rank="No.2"
              subtitle="Venue: Odaiba Park"
              title="Tokyo Gourmet Festival"
            />
          </div>
          <div
            className={`transition-all duration-300 ease-out ${
          ...
          >
            <SearchResultCard
              ...
              rank="No.3"
              subtitle="Venue : Roppongi Hills"
              title="Tokyo winter Illumination 2025"
            />
          </div>
        </div>
      </div>
      ...
      <div className="relative flex min-h-dvh flex-col px-[16px] pb-[140px] pt-[max(42px,env(safe-area-inset-top))]">
        <div className="flex flex-col items-center gap-[11px]">
          ...
          <div className="flex items-center justify-center gap-[9px]">
            <div className="w-[67px]">
              <FilterChip icon={discoverAssets.music} iconClassName="h-[13px] w-[9px]" label="Music" />
            </div>
            <div className="w-[67px]">
              <FilterChip icon={discoverAssets.food} iconClassName="h-[15px] w-[11px]" label="Food" />
            </div>
        ...
        <div className="relative flex-1">
          ...
          <DiscoverMarker className="left-[219px] top-[31px] px-[8px] py-[11px]">
            ...
            <span className="text-[13px] font-medium uppercase tracking-[0.5px] text-black">ODEN EVENT</span>
          </DiscoverMarker>
          ...
          {showJazzPreview ? (
            ...
            >
              ...
              <span className="text-[13px] font-medium uppercase tracking-[0.5px] text-black">JAZZ NIGHT</span>
            </DiscoverMarker>
          )}
          ...
          <DiscoverMarker className="left-0 top-[293px] py-[12px] pl-[9px] pr-[14px]">
            ...
            <span className="text-[13px] font-medium uppercase tracking-[0.5px] text-black">WORKSHOP</span>
          </DiscoverMarker>
